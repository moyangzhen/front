...
confirmed:confirmation" v-slot="{ errors }">
                      <div class="layui-row">
...
[0] }}</span>
                  ...
                  <div class="layui-form-item fly-form-app">
                    ...
                    <a href onclick="layer.msg('正在通过QQ登入',
{icon:16, shade: 0.1, time:0})" class="iconfont icon-qq" title="QQ登入"></a>
                    <a href onclick="layer.msg('正在通过微博登入',
{icon:16, shade: 0.1, time:0})" class="iconfont icon-weibo" title="微博登入"></a>
                  </div>
                </form>
              </div>
            </div>
